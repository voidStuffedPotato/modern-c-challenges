...
bool
is_sorted(int target[static 1], size_t size) {
...
void
merge_sort(int target[static 1], size_t left, size_t right) {
#if !NDEBUG
...
void
merge(int target[static 2], size_t left, size_t center, size_t right) {
...
void
quick_sort(int target[static 1], int left, int right) {
    if (right <= left)
        return;
    else {
...
int
partition(int target[static 2], int left, int right) {
